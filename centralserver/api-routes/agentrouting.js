...
router.get('/getClientReq', async(req,res) => {
  ...
  // let clientQ = await swaggyDatabase.checkClientQ(department);
  // console.log("This is the x we want")
  // let ChatQ = clientQ.Chat;
  // let AudioQ = clientQ.Audio;
  // let VideoQ = clientQ.Video;
  console.log(ChatQ);
});
